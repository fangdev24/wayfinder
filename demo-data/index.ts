...
export const solidConfig = {
  ...
  // Key demo WebIDs for testing
  demoWebIds: {
    // Key people across departments
    riverStone: 'http://localhost:3002/river-stone/profile#me',
    ashMorgan: 'http://localhost:3002/ash-morgan/profile#me',
    slateWylder: 'http://localhost:3002/slate-wylder/profile#me',
    flintRivers: 'http://localhost:3002/flint-rivers/profile#me',
    heathWillows: 'http://localhost:3002/heath-willows/profile#me',

    // Key teams
    puffinTeam: 'http://localhost:3002/puffin-team/profile#team',
    graniteTeam: 'http://localhost:3002/granite-team/profile#team',
    wolfTeam: 'http://localhost:3002/wolf-team/profile#team',
  },
};
