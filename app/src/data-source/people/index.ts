...
export const people: Person[] = [
  ...
  {
    id: 'flint-rivers',
    webId: `${POD_BASE}/flint-rivers/profile/card#me`,
    name: 'Flint Rivers',
    departmentId: 'dso',
  ...
  {
    id: 'brook-alder',
    webId: `${POD_BASE}/brook-alder/profile/card#me`,
    name: 'Brook Alder',
    departmentId: 'dso',
    teamId: 'granite-platform',
    role: 'Senior SRE',
  ...
  {
    id: 'sage-thornton',
    webId: `${POD_BASE}/sage-thornton/profile/card#me`,
    name: 'Sage Thornton',
    departmentId: 'dso',
    teamId: 'cedar-design',
  ...
  {
    id: 'rowan-marsh',
    webId: `${POD_BASE}/rowan-marsh/profile/card#me`,
    name: 'Rowan Marsh',
    departmentId: 'dso',
    teamId: 'birch-notify',
    role: 'Tech Lead',
  ...
  {
    id: 'ivy-banks',
    webId: `${POD_BASE}/ivy-banks/profile/card#me`,
    name: 'Ivy Banks',
    departmentId: 'dso',
    teamId: 'willow-pay',
  ...
  {
    id: 'river-stone',
    webId: `${POD_BASE}/river-stone/profile/card#me`,
    name: 'River Stone',
    departmentId: 'dcs',
  ...
  {
    id: 'hazel-brook',
    webId: `${POD_BASE}/hazel-brook/profile/card#me`,
    name: 'Hazel Brook',
    departmentId: 'dcs',
    teamId: 'puffin-delivery',
    role: 'Senior Developer',
  ...
  {
    id: 'clay-fielding',
    webId: `${POD_BASE}/clay-fielding/profile/card#me`,
    name: 'Clay Fielding',
    departmentId: 'dcs',
  ...
  {
    id: 'fern-whitley',
    webId: `${POD_BASE}/fern-whitley/profile/card#me`,
    name: 'Fern Whitley',
    departmentId: 'dcs',
  ...
  {
    id: 'ash-morgan',
    webId: `${POD_BASE}/ash-morgan/profile/card#me`,
    name: 'Ash Morgan',
    departmentId: 'rts',
    teamId: 'falcon-core',
  ...
  {
    id: 'reed-oakley',
    webId: `${POD_BASE}/reed-oakley/profile/card#me`,
    name: 'Reed Oakley',
    departmentId: 'rts',
    teamId: 'kestrel-api',
    role: 'API Lead',
  ...
  {
    id: 'storm-vale',
    webId: `${POD_BASE}/storm-vale/profile/card#me`,
    name: 'Storm Vale',
    departmentId: 'rts',
    teamId: 'merlin-data',
  ...
  {
    id: 'wren-hartley',
    webId: `${POD_BASE}/wren-hartley/profile/card#me`,
    name: 'Wren Hartley',
    departmentId: 'rts',
  ...
  {
    id: 'slate-wylder',
    webId: `${POD_BASE}/slate-wylder/profile/card#me`,
    name: 'Slate Wylder',
    departmentId: 'bia',
  ...
  {
    id: 'gale-frost',
    webId: `${POD_BASE}/gale-frost/profile/card#me`,
    name: 'Gale Frost',
    departmentId: 'bia',
    teamId: 'bear-border',
  ...
  {
    id: 'laurel-finch',
    webId: `${POD_BASE}/laurel-finch/profile/card#me`,
    name: 'Laurel Finch',
    departmentId: 'bia',
  ...
  {
    id: 'cliff-ashford',
    webId: `${POD_BASE}/cliff-ashford/profile/card#me`,
    name: 'Cliff Ashford',
    departmentId: 'bia',
  ...
  {
    id: 'moss-sterling',
    webId: `${POD_BASE}/moss-sterling/profile/card#me`,
    name: 'Moss Sterling',
    departmentId: 'vla',
  ...
  {
    id: 'dale-heather',
    webId: `${POD_BASE}/dale-heather/profile/card#me`,
    name: 'Dale Heather',
    departmentId: 'vla',
  ...
  {
    id: 'pine-holloway',
    webId: `${POD_BASE}/pine-holloway/profile/card#me`,
    name: 'Pine Holloway',
    departmentId: 'vla',
  ...
  {
    id: 'heath-willows',
    webId: `${POD_BASE}/heath-willows/profile/card#me`,
    name: 'Heath Willows',
    departmentId: 'nhds',
    teamId: 'oak-records',
  ...
  {
    id: 'juniper-cole',
    webId: `${POD_BASE}/juniper-cole/profile/card#me`,
    name: 'Juniper Cole',
    departmentId: 'nhds',
  ...
  {
    id: 'birch-tanner',
    webId: `${POD_BASE}/birch-tanner/profile/card#me`,
    name: 'Birch Tanner',
    departmentId: 'nhds',
  ...
  {
    id: 'aspen-grey',
    webId: `${POD_BASE}/aspen-grey/profile/card#me`,
    name: 'Aspen Grey',
    departmentId: 'nhds',
